...
extension XBoardProfileStringSaveExtension on Profile {
  Future<Profile> saveFileWithString(String content) {
    return saveFile(Uint8List.fromList(utf8.encode(content)));
  }
}

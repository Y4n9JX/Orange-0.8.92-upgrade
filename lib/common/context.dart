...
extension BuildContextExtension on BuildContext {
  ...
  void showSnackBar(String message, {SnackBarAction? action}) {
    ...
    // Remove any active SnackBar immediately before showing a new one.
    // Using removeCurrentSnackBar avoids leaving the old SnackBar's Hero in
    // the route subtree during page transitions, which can trigger duplicate
    // SnackBar Hero tag exceptions.
    scaffoldMessenger
      ..clearSnackBars()

...
mixin _$LoginData {
 ...
 String? get token;@JsonKey(name: 'auth_data') String? get authData; Map<String, dynamic>? get user;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginData&&(identical(other.token, token) || other.token == token)&&(identical(other.authData, authData) || other.authData == authData)&&const DeepCollectionEquality().equals(other.user, user));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,token,authData,const DeepCollectionEquality().hash(user));
...
@useResult
$Res call({
 String? token,@JsonKey(name: 'auth_data') String? authData, Map<String, dynamic>? user
});
...
/// Create a copy of LoginData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = freezed,Object? authData = freezed,Object? user = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? token, @JsonKey(name: 'auth_data')  String? authData,  Map<String, dynamic>? user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginData() when $default != null:
return $default(_that.token,_that.authData,_that.user);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? token, @JsonKey(name: 'auth_data')  String? authData,  Map<String, dynamic>? user)  $default,) {final _that = this;
switch (_that) {
case _LoginData():
return $default(_that.token,_that.authData,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? token, @JsonKey(name: 'auth_data')  String? authData,  Map<String, dynamic>? user)?  $default,) {final _that = this;
switch (_that) {
case _LoginData() when $default != null:
return $default(_that.token,_that.authData,_that.user);case _:
  return null;
...
class _LoginData implements LoginData {
  const _LoginData({this.token, @JsonKey(name: 'auth_data') this.authData, final  Map<String, dynamic>? user}): _user = user;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginData&&(identical(other.token, token) || other.token == token)&&(identical(other.authData, authData) || other.authData == authData)&&const DeepCollectionEquality().equals(other._user, _user));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,token,authData,const DeepCollectionEquality().hash(_user));
...
/// Create a copy of LoginData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = freezed,Object? authData = freezed,Object? user = freezed,}) {
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.success, this.message, this.data});

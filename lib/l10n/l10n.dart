...
class AppLocalizations {
  ...
  String deleteMultipTip(String label) {
    return Intl.message(
      'Are you sure you want to delete the selected $label?',
  ...
  String get addProfile {
    return Intl.message('addProfile', name: 'addProfile', desc: '', args: []);
  }

  /// `addedRules`
  String get addedRules {
    return Intl.message('addedRules', name: 'addedRules', desc: '', args: []);
  }
  ...
  String get coreStatus {
    return Intl.message('coreStatus', name: 'coreStatus', desc: '', args: []);
  }

  /// `crashlytics`
  String get crashlytics {
    return Intl.message('crashlytics', name: 'crashlytics', desc: '', args: []);
  }
  ...
  String get delayTest {
    return Intl.message('delayTest', name: 'delayTest', desc: '', args: []);
  }
  ...
  /// `editRule`
  String get editRule {
    return Intl.message('editRule', name: 'editRule', desc: '', args: []);
  }
  ...
  /// `loadTest`
  String get loadTest {
    return Intl.message('loadTest', name: 'loadTest', desc: '', args: []);
  }
  ...
  String get networkType {
    return Intl.message('networkType', name: 'networkType', desc: '', args: []);
  }
  ...
  String get proxyChains {
    return Intl.message('proxyChains', name: 'proxyChains', desc: '', args: []);
  }

  /// `pruneCache`
  String get pruneCache {
    return Intl.message('pruneCache', name: 'pruneCache', desc: '', args: []);
  }
  ...
  /// `turnOff`
  String get turnOff {
    return Intl.message('turnOff', name: 'turnOff', desc: '', args: []);
  }

  /// `turnOn`
  String get turnOn {
    return Intl.message('turnOn', name: 'turnOn', desc: '', args: []);
  }

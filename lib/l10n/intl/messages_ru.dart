...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(count) => "${count} дней назад";
  ...
  static String m4(label) => "${label} детали";

  static String m5(label) => "${label} не может быть пустым";

  static String m6(label) => "Текущий ${label} уже существует";

  static String m7(count) => "${count} часов назад";

  static String m10(count) => "${count} минут назад";

  static String m11(count) => "${count} месяцев назад";

  static String m12(label) => "${label} пока отсутствуют";
  ...
  static String m40(count) => "${count} лет назад";

...
class XBoardHttpClient {
  ...
  HttpResult<T> _handleError<T>(dynamic error) {
    if (error is DioException) {
      switch (error.type) {
        case DioExceptionType.connectionTimeout:
          return const HttpFailure('连接超时', errorType: HttpErrorType.timeout);
        case DioExceptionType.sendTimeout:
          return const HttpFailure('发送超时', errorType: HttpErrorType.timeout);
        case DioExceptionType.receiveTimeout:
          return const HttpFailure('接收超时', errorType: HttpErrorType.timeout);
        ...
        case DioExceptionType.cancel:
          return const HttpFailure('请求已取消', errorType: HttpErrorType.cancel);
    ...
    return HttpFailure('请求异常: $error', errorType: HttpErrorType.unknown);
  }

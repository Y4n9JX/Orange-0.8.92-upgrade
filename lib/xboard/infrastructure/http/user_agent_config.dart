...
class UserAgentConfig {
  ...
  static const Map<String, String> _defaultUserAgents = {
    'api_encrypted': 'Mozilla/5.0 (compatible; FlClash-API/1.0)',
  ...
  static Future<String> get(UserAgentScenario scenario) async {
    ...
    switch (scenario) {
      ...
      case UserAgentScenario.domainRacingTest:
        ...
        if (!userAgents.containsKey(key) || (userAgents[key]?.trim().isEmpty ?? true)) {
          final fallback = _defaultUserAgents[key];
          if (fallback != null) {
            return fallback;
          }
          throw Exception(
